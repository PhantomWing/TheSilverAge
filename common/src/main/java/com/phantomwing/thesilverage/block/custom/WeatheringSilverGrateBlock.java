...
/**
 * {@link WeatheringCopperGrateBlock} that honours the {@code enable_silver_oxidation} config.
 *
 ...
 */
public class WeatheringSilverGrateBlock extends WeatheringCopperGrateBlock {
    public WeatheringSilverGrateBlock(WeatheringCopper.WeatherState weatherState, BlockBehaviour.Properties properties) {
