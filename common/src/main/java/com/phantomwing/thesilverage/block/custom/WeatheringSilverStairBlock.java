...
/**
 * {@link WeatheringCopperStairBlock} that honours the {@code enable_silver_oxidation} config.
 *
 ...
 */
public class WeatheringSilverStairBlock extends WeatheringCopperStairBlock {
    public WeatheringSilverStairBlock(WeatheringCopper.WeatherState weatherState, BlockState baseState, BlockBehaviour.Properties properties) {
