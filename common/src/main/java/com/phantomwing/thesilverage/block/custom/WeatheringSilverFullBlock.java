...
/**
 * {@link WeatheringCopperFullBlock} that honours the {@code enable_silver_oxidation} config.
 *
 ...
 */
public class WeatheringSilverFullBlock extends WeatheringCopperFullBlock {
    public WeatheringSilverFullBlock(WeatheringCopper.WeatherState weatherState, BlockBehaviour.Properties properties) {
