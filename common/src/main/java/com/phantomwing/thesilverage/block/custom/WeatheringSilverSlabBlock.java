...
/**
 * {@link WeatheringCopperSlabBlock} that honours the {@code enable_silver_oxidation} config.
 *
 ...
 */
public class WeatheringSilverSlabBlock extends WeatheringCopperSlabBlock {
    public WeatheringSilverSlabBlock(WeatheringCopper.WeatherState weatherState, BlockBehaviour.Properties properties) {
