package com.phantomwing.thesilverage.neoforge.world;
...
public class ModBiomeModifiers {
    ...
    private static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(NeoForgeRegistries.Keys.BIOME_MODIFIERS, Identifier.fromNamespaceAndPath(TheSilverAge.MOD_ID, name));
    }
}
