...
public class ModFireworks {
    private static final Map<Item, FireworkRocketItem.Shape> SHAPE_ITEMS = Util.make(Maps.newHashMap(), (map) -> {
        map.put(ModItems.SILVER_NUGGET.get(), FireworkRocketItem.Shape.STAR);
    });
    ...
    public static void register() {
        ...
        Map<Item, FireworkRocketItem.Shape> items = new HashMap<>(Map.copyOf(SHAPE_ITEMS));
