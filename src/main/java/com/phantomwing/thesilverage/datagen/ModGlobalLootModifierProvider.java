...
public class ModGlobalLootModifierProvider extends GlobalLootModifierProvider {
    ...
    protected void start() {
        ...
        add("silver_horse_armor_from_desert_pyramid", new ReplaceItemModifier(
                ...
                ModItems.SILVER_HORSE_ARMOR.get(),
    ...
    private LootItemCondition[] conditions(ResourceLocation lootTable, LootItemCondition... extraConditions) {
        return conditions(lootTable, 1.0f, extraConditions);
    }

    private LootItemCondition[] conditions(ResourceLocation lootTable, float chance, LootItemCondition... extraConditions) {
        LootItemCondition[] conditions = new LootItemCondition[extraConditions.length + 2];

        conditions[0] = isVanillaLootTable(lootTable);
    ...
    private LootItemCondition isVanillaLootTable(ResourceLocation lootTable) {
        return new LootTableIdCondition.Builder(new ResourceLocation(lootTable.getPath())).build();
    }
}
